...
using OrbitalOptics.API;
using OrbitalOptics.API.Core;
using OrbitalOptics.API.Extensions;
...
builder.Services.AddTransient<OrbitalOpticsContext>(x => new OrbitalOpticsContext(settings.ConnectionString));
...
builder.Services.AddTransient<IApplicationActorProvider>(x =>
{
    ...
    var context = x.GetService<OrbitalOpticsContext>();
